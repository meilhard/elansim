#line 1 "h:\\c_projekte\\elansim\\waitdialog.cpp"
...
#line 6 "h:\\c_projekte\\elansim\\waitdialog.cpp"
...
#line 8 "h:\\c_projekte\\elansim\\waitdialog.cpp"
...
#line 9 "h:\\c_projekte\\elansim\\waitdialog.cpp"
#line 1 "c:\\qt\\include\\qrect.h"
...
#line 10 "h:\\c_projekte\\elansim\\waitdialog.cpp"
...
WaitDialog::WaitDialog(QWidget* parent) : QDialog(parent, "WaitDialog", false, WStyle_Customize|WStyle_DialogBorder|WStyle_Title)
{
	...
	QPoint top_left = pos.topLeft();
	QPoint top_right = pos.topRight();
	QPoint bottom_left = pos.bottomLeft();

	int width = top_right.x() - top_left.x();
	int height = bottom_left.y() - top_left.y();

	QPoint middle(top_left.x() + width/2, top_left.y() + height/3);

	QRect new_geom;
	new_geom.setWidth(300);
	new_geom.setHeight(70);

	new_geom.moveCenter(middle);
