#line 1 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 28 "c:\\coin3d\\include\\inventor\\sbtime.h"
...
#line 10 "h:\\c_projekte\\elansim\\wizard.cpp"
...
public:
    ...
    bool	lineShapesOk()	const { return 1; }
...
#line 12 "h:\\c_projekte\\elansim\\wizard.cpp"
#line 1 "c:\\qt\\include\\qgroupbox.h"
...
#line 43 "c:\\qt\\include\\qgroupbox.h"
#line 44 "c:\\qt\\include\\qgroupbox.h"
...
class __declspec(dllimport) QGroupBox : public QFrame
{
    public: QMetaObject *metaObject() const { return staticMetaObject(); } const char *className() const; static QMetaObject* staticMetaObject(); static QString tr(const char*); static QString tr(const char*, const char*); protected: void initMetaObject(); private: static QMetaObject *metaObj;
...
private:
    ...
    QAccel * accel;
#line 113 "c:\\qt\\include\\qgroupbox.h"
    QGroupBoxPrivate * d;
...
#line 127 "c:\\qt\\include\\qgroupbox.h"
};


#line 131 "c:\\qt\\include\\qgroupbox.h"

#line 133 "c:\\qt\\include\\qgroupbox.h"
#line 13 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 14 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 15 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 16 "h:\\c_projekte\\elansim\\wizard.cpp"
#line 1 "c:\\qt\\include\\qvariant.h"
...
#line 17 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 18 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 19 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 20 "h:\\c_projekte\\elansim\\wizard.cpp"
#line 1 "c:\\qt\\include\\qpixmap.h"
...
#line 21 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 22 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 23 "h:\\c_projekte\\elansim\\wizard.cpp"
...
public:
    ...
    void	repaint( bool erase=1 );
    void	repaint( int x, int y, int w, int h, bool erase=1 );
    void	repaint( const QRect &, bool erase=1 );
...
protected:
   ...
   ~QTableView();
    ...
    virtual void setOffset( int x, int y, bool updateScrBars = 1 );
    ...
    void	updateCell( int row, int column, bool erase=1 );
...
private:
    ...
    virtual void	setHorScrollBar( bool on, bool update = 1 );
    virtual void	setVerScrollBar( bool on, bool update = 1 );
    void	updateView();
    int		findRawRow( int yPos, int *cellMaxY, int *cellMinY = 0,
			    bool goOutsideView = 0 ) const;
...
public:
   ...
   ~QMultiLineEdit();
    ...
    virtual void insertAt( const QString &s, int line, int col, bool mark = 0 );
...
protected:
    ...
    virtual void pageUp( bool mark=0 );
    virtual void pageDown( bool mark=0 );
    virtual void cursorLeft( bool mark=0, bool wrap = 1 );
    virtual void cursorRight( bool mark=0, bool wrap = 1 );
    virtual void cursorUp( bool mark=0 );
    virtual void cursorDown( bool mark=0 );
    virtual void backspace();
    virtual void del();
    virtual void home( bool mark=0 );
    virtual void end( bool mark=0 );
...
#line 265 "c:\\qt\\include\\qmultilineedit.h"
	...
	QMultiLineEditRow( QString string, int width, bool nl = 1 )
    ...
    void	setCursorPixelPosition(QPoint p, bool clear_mark=1);
    ...
    void 	newMark( int posx, int posy, bool copy=1 );
...
#line 321 "c:\\qt\\include\\qmultilineedit.h"
    ...
    void	rebreakAll();
    void	insertAtAux( const QString &s, int line, int col, bool mark = 0 );
    void	killLineAux();
    void	delAux();
...
#line 24 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 25 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 26 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 27 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 28 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 29 "h:\\c_projekte\\elansim\\wizard.cpp"
#line 1 "c:\\qt\\include\\qregexp.h"
...
#line 30 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 31 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 33 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 34 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 35 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 36 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 37 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 38 "h:\\c_projekte\\elansim\\wizard.cpp"
#line 1 "c:\\coin3d\\include\\inventor\\nodes\\socallback.h"
...
#line 39 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 40 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 41 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 42 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 43 "h:\\c_projekte\\elansim\\wizard.cpp"
#line 1 "c:\\coin3d\\include\\inventor\\actions\\soaction.h"
...
#line 44 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 46 "h:\\c_projekte\\elansim\\wizard.cpp"
...
#line 47 "h:\\c_projekte\\elansim\\wizard.cpp"

#line 1 "h:\\c_projekte\\elansim\\images.h"
...
#line 331 "h:\\c_projekte\\elansim\\images.h"
#line 49 "h:\\c_projekte\\elansim\\wizard.cpp"
...
void ConnectionWizard::buildWidget()
{
    ...
    lblTopGraphic->setScaledContents( 1 );

    txtInfo = new QLabel( frmTop, "txtInfo" );
    txtInfo->setGeometry( QRect( 20, 30, 250, 21 ) ); 
    txtInfo->setText( tr( "" ) );
    txtInfo->setScaledContents( 0 );
	txtInfo->setBackgroundColor(QColor(255, 255, 255));

	connect (btnCancel, "2""clicked()", this, "1""onCancel()");
	connect (btnOK, "2""clicked()", this, "1""onOK()");
}
...
void ConnectionWizard::buildPage1()
{
    ...
    cmbServer = new QComboBox( 0, page1, "cmbServer" );
	...
	connect(cmbServer, "2""activated(int)", this, "1""onCmbServer(int)");
}
...
void ConnectionWizard::buildPage2()
{
	...
	connect(lsvScenes, "2""doubleClicked(QListViewItem*)" , this, "1""onSelect(QListViewItem*)" );
...
void ConnectionWizard::buildPage3()
{
    ...
    cmbAvatars = new QComboBox( 0, page3, "cmbAvatars" );
	...
	connect(cmbAvatars, "2""activated(int)", this, "1""onCmbAvatar(int)" );
...
void ConnectionWizard::_setBuffer()
{
	...
	_length = sizeof(_sessionId) + sizeof(_sceneId) + _title.length();
	_buffer = new char[_length];

	memcpy(_buffer, &_sceneId, sizeof(_sceneId));
	memcpy(_buffer + sizeof(_sceneId), &_sessionId, sizeof(_sessionId));
	memcpy(_buffer + sizeof(_sceneId) + sizeof(_sessionId), _title.ascii(), _title.length());
...
int ConnectionWizard::_connect()
{
	...
	connect(_c, "2""dataReceived(IO_Flag)", this, "1""onReceive(IO_Flag)");
...
int ConnectionWizard::_login()
{
	...
	if ( (user + passwd).length() != 0) {
		qstrcpy( msg, user.ascii() );
		qstrcpy( msg + user.length() + 1 , passwd.ascii() );
	}

	try {
		_c->send(login, msg, qstrlen(user)+qstrlen(passwd)+2);
	} catch ( Con_Exception& e) {
		txtInfo->setText( QString("Error: ") + QString(e.msg) );
		page1->show();
...
void ConnectionWizard::_getAvatarEntries()
{
	...
	for (uint k = 0; k < pathlist.count(); k++) {
		SoInput in;
		if (in.openFile(pathlist[k].ascii())) {
			SoVRMLGroup* child = SoDB::readAllVRML(&in);
			_switch->addChoice(child);
		}
	}
