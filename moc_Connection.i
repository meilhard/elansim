#line 1 "h:\\c_projekte\\elansim\\moc_connection.cpp"
...
#line 16 "h:\\c_projekte\\elansim\\moc_connection.cpp"
...
#line 18 "h:\\c_projekte\\elansim\\moc_connection.cpp"
#line 1 "c:\\qt\\include\\qmetaobject.h"
...
#line 1 "c:\\qt\\include\\qconnection.h"
...
#line 43 "c:\\qt\\include\\qconnection.h"
#line 44 "c:\\qt\\include\\qconnection.h"
...
#line 73 "c:\\qt\\include\\qconnection.h"
};


#line 77 "c:\\qt\\include\\qconnection.h"
#line 43 "c:\\qt\\include\\qmetaobject.h"
...
#line 44 "c:\\qt\\include\\qmetaobject.h"
#line 45 "c:\\qt\\include\\qmetaobject.h"
...
#line 131 "c:\\qt\\include\\qmetaobject.h"
...
#line 153 "c:\\qt\\include\\qmetaobject.h"
    ...
    QMetaData	*slot( int index, bool super = 0 ) const;
    QMetaData	*signal( int index, bool super = 0 ) const;

    QMetaData	*slot( const char *, bool super = 0 ) const;
    QMetaData	*signal( const char *, bool super = 0 ) const;

    QStrList	slotNames( bool super = 0 ) const;
    QStrList	signalNames( bool super = 0 ) const;

    int		numClassInfo( bool super = 0 ) const;
    QClassInfo 	*classInfo( int index, bool super = 0 ) const;
    const char 	*classInfo( const char* name, bool super = 0 ) const;


    const QMetaProperty	*property( const char* name, bool super = 0 ) const;
    QStrList		propertyNames( bool super = 0 ) const;
    void		resolveProperty( QMetaProperty* prop );
#line 186 "c:\\qt\\include\\qmetaobject.h"
    ...
    static QMetaObject	*new_metaobject( const char *, const char *,
					...
					QMetaProperty *prop_data, int n_props,
					QMetaEnum *enum_data, int n_enums,
#line 197 "c:\\qt\\include\\qmetaobject.h"
					QClassInfo * class_info, int n_info );
    static QMetaObject	*new_metaobject( const char *, const char *,
					QMetaData *, int,
					QMetaData *, int );
...
private:
    ...
    QMetaEnum		*enumerator( const char* name, bool super = 0 ) const;

private:	



#line 233 "c:\\qt\\include\\qmetaobject.h"
};
...
{ flags &= ~(uint)f; }
#line 255 "c:\\qt\\include\\qmetaobject.h"


class __declspec(dllimport) QMetaObjectInit {
public:
    QMetaObjectInit(void(*)());
    static int init();
};

#line 264 "c:\\qt\\include\\qmetaobject.h"
#line 19 "h:\\c_projekte\\elansim\\moc_connection.cpp"
...
void bitBlt( QPaintDevice *dst, int dx, int dy,
	     ...
	     Qt::RasterOp = Qt::CopyROP, bool ignoreMask=0 );
...
inline void bitBlt( QPaintDevice *dst, const QPoint &dp,
		    ...
		    Qt::RasterOp rop=Qt::CopyROP, bool ignoreMask=0 )
{
...
public:
    ...
    QFont( const QString &family, int pointSize = 12,
	   int weight = Normal, bool italic = 0 );
...
#line 216 "c:\\qt\\include\\qfont.h"
    ...
    HFONT	create( bool *, HDC=0, bool=0 ) const;
...
#line 73 "c:\\qt\\include\\qstyle.h"
    ...
    virtual void drawExclusiveIndicator( QPainter* p, int x, int y, int w, int h,
		    const QColorGroup &g, bool on, bool down = 0, bool enabled = 1 ) = 0;
    ...
    virtual void drawIndicator( QPainter* p, int x, int y, int w, int h, const QColorGroup &g,
				int state, bool down = 0, bool enabled = 1 ) = 0;
...
public:
    ...
    QSizePolicy( SizeType hor, SizeType ver, bool hfw = 0 );
...
public :
    ...
    void		repaint( const QRegion &, bool erase=1 );
...
#line 485 "c:\\qt\\include\\qwidget.h"
    ...
    virtual void create( WId = 0, bool initializeWindow = 1,
			 bool destroyOldWindow = 1 );
    virtual void destroy( bool destroyWindow = 1,
			  bool destroySubWindows = 1 );
    ...
    virtual void setMicroFocusHint(int x, int y, int w, int h, bool text=1);
...
{ repaint( 0, 0, crect.width(), crect.height(), 1 ); }
...
#line 20 "h:\\c_projekte\\elansim\\moc_connection.cpp"



#line 24 "h:\\c_projekte\\elansim\\moc_connection.cpp"

#line 26 "h:\\c_projekte\\elansim\\moc_connection.cpp"


const char *Connection::className() const
{
    return "Connection";
}

QMetaObject *Connection::metaObj = 0;

void Connection::initMetaObject()
{
    if ( metaObj )
	return;
    if ( qstrcmp(QObject::className(), "QObject") != 0 )
	badSuperclassWarning("Connection","QObject");
    (void) staticMetaObject();
}


QString Connection::tr(const char* s)
{
    return ((QApplication*)qApp)->translate("Connection",s);
}

#line 51 "h:\\c_projekte\\elansim\\moc_connection.cpp"
QMetaObject* Connection::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
    (void) QObject::staticMetaObject();

#line 58 "h:\\c_projekte\\elansim\\moc_connection.cpp"
    QMetaData::Access *slot_tbl_access = 0;
    typedef void(Connection::*m2_t0)(IO_Flag);
    m2_t0 v2_0 = & Connection::dataReceived;
    QMetaData *signal_tbl = QMetaObject::new_metadata(1);
    signal_tbl[0].name = "dataReceived(IO_Flag)";
	...
	0, 0,
	0, 0,
#line 72 "h:\\c_projekte\\elansim\\moc_connection.cpp"
	0, 0 );
    metaObj->set_slot_access( slot_tbl_access );

#line 76 "h:\\c_projekte\\elansim\\moc_connection.cpp"
    return metaObj;
}
...
#line 80 "h:\\c_projekte\\elansim\\moc_connection.cpp"
#line 1 "c:\\qt\\include\\qsignalslotimp.h"
...
#line 43 "c:\\qt\\include\\qsignalslotimp.h"
#line 1 "c:\\qt\\include\\qlist.h"
...
#line 44 "c:\\qt\\include\\qsignalslotimp.h"
#line 1 "c:\\qt\\include\\qasciidict.h"
...
#line 45 "c:\\qt\\include\\qsignalslotimp.h"
#line 46 "c:\\qt\\include\\qsignalslotimp.h"



template class __declspec(dllimport) QList<QConnection>;
template class __declspec(dllimport) QListIterator<QConnection>;
#line 52 "c:\\qt\\include\\qsignalslotimp.h"


class __declspec(dllimport) QConnectionList : public QList<QConnection>
{
public:
...
class __declspec(dllimport) QConnectionListIt : public QListIterator<QConnection>
{
public:
...
template class __declspec(dllimport) QAsciiDict<QConnectionList>;
template class __declspec(dllimport) QAsciiDictIterator<QConnectionList>;
#line 77 "c:\\qt\\include\\qsignalslotimp.h"


class __declspec(dllimport) QSignalDict : public QAsciiDict<QConnectionList>
{
public:
    QSignalDict(int size=17,bool cs=1,bool ck=1)
...
class __declspec(dllimport) QSignalDictIt : public QAsciiDictIterator<QConnectionList>
{
public:
...
#line 102 "c:\\qt\\include\\qsignalslotimp.h"
#line 81 "h:\\c_projekte\\elansim\\moc_connection.cpp"


void Connection::dataReceived( IO_Flag t0 )
{
    
    QConnectionList *clist = receivers("dataReceived(IO_Flag)");
    if ( !clist || signalsBlocked() )
	return;
    typedef void (QObject::*RT0)();
    typedef RT0 *PRT0;
    typedef void (QObject::*RT1)(IO_Flag);
    typedef RT1 *PRT1;
    RT0 r0;
    RT1 r1;
